...
contract DevToken is ERC20, Ownable {
    ...
    function withdrawStakes(uint256 stake_index) public {
    ...
    function _withdrawStakes() internal returns (uint256){
        ...
        for (uint256 index = 0; s < stakeholders[user_index].address_stakes.length; s += 1) {
    ...
    function calculateStakeReward(Stake memory _current_stake) internal view returns (uint256) {
        ...
        uint256 reward = (_current_stake.amount * daysStaked * 11111111111111111111111) / (100000000 * 10 ** 18 * 365);
        return reward;
    }
